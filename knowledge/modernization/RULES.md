...
Define the purpose of engineering rules for **Modernization**.
...
Identify modernization blockers and sequencing risks from engineering evidence.
...
<!-- TODO: Author category taxonomy for modernization without listing implemented rule IDs. -->
