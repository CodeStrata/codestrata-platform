...
Define the purpose of engineering rules for **Portfolio**.
...
Define how portfolio-level rules differ from repo-local rules (aggregation, concentration).
...
<!-- TODO: Author category taxonomy for portfolio without listing implemented rule IDs. -->
