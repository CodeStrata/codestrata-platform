...
Define the purpose of engineering rules for **Architecture**.
...
Detect structural risks and architectural hygiene from repository evidence.
...
<!-- TODO: Author category taxonomy for architecture without listing implemented rule IDs. -->
