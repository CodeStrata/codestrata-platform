...
Define the purpose of engineering rules for **Performance**.
...
Identify performance anti-patterns and scalability risks from repository evidence.
...
<!-- TODO: Author category taxonomy for performance without listing implemented rule IDs. -->
