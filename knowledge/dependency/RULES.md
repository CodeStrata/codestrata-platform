...
Define the purpose of engineering rules for **Dependency**.
...
Identify dependency hygiene and supply-chain risks from manifests and lockfiles.
...
<!-- TODO: Author category taxonomy for dependency without listing implemented rule IDs. -->
