...
Define the purpose of engineering rules for **Documentation**.
...
Detect missing, stale, or incoherent engineering documentation signals.
...
<!-- TODO: Author category taxonomy for documentation without listing implemented rule IDs. -->
