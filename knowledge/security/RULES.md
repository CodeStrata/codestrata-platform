...
Define the purpose of engineering rules for **Security**.
...
Detect security hygiene and sensitive-evidence risks from repository signals.
...
<!-- TODO: Author category taxonomy for security without listing implemented rule IDs. -->
