...
Define the purpose of engineering rules for **Technical Debt**.
...
Detect maintainability and complexity debt signals from static evidence.
...
<!-- TODO: Author category taxonomy for technical-debt without listing implemented rule IDs. -->
