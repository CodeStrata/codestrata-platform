...
Define the purpose of engineering rules for **AI Readiness**.
...
Surface AI readiness gaps and unsafe AI integration patterns from evidence.
...
<!-- TODO: Author category taxonomy for ai without listing implemented rule IDs. -->
