...
Define the purpose of engineering rules for **Cloud**.
...
Identify cloud readiness gaps and cloud-hygiene risks from repository evidence.
...
<!-- TODO: Author category taxonomy for cloud without listing implemented rule IDs. -->
