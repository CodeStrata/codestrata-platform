"""Cloud assessment identifiers and constants (Phase 4.7.1)."""
...
SECTION_ID = "assessment.cloud"
SCHEMA_NAME = "cloud-assessment"
SECTION_SCHEMA_VERSION = "1.2.0"
CLOUD_ASSESSMENT_FILENAME = "cloud-assessment.json"
ARTIFACT_SCHEMA_ID = "codestrata.cloud_assessment"
...
def build_assessment_id(
    *,
    ...
    return f"cloud-assessment:{digest}"
