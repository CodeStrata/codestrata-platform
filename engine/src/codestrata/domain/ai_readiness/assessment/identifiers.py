"""AI Readiness assessment identifiers and constants (Phase 4.8.5)."""
...
SECTION_ID = "assessment.ai_readiness"
SCHEMA_NAME = "ai-readiness-assessment"
SECTION_SCHEMA_VERSION = "1.2.0"
AI_READINESS_ASSESSMENT_FILENAME = "ai-readiness-assessment.json"
ARTIFACT_SCHEMA_ID = "codestrata.ai_readiness_assessment"
...
def build_assessment_id(
    *,
    ...
    return f"ai-readiness-assessment:{digest}"
...
def build_trace_edge_id(*, relation: str, source_id: str, target_id: str) -> str:
    ...
    digest = hashlib.sha256(payload.encode("utf-8")).hexdigest()[:16]
    return f"ai-readiness-trace:{digest}"
