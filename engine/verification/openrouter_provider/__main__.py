"""CLI entry: ``python -m verification.openrouter_provider``."""
...
from verification.openrouter_provider.contract import REPORT_FILENAME, REPORT_MD_FILENAME
from verification.openrouter_provider.reporting import report_directory, verdict_is_allowed
from verification.openrouter_provider.runner import engine_root, run_verification


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="SV.11.9 OpenRouter Provider Verification")
    ...
    print(f"SV.11.9 OpenRouter Provider Verification: {report.verdict}")
