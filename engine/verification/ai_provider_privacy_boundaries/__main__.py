"""CLI entry: ``python -m verification.ai_provider_privacy_boundaries``."""
...
from verification.ai_provider_privacy_boundaries.contract import REPORT_FILENAME, REPORT_MD_FILENAME
from verification.ai_provider_privacy_boundaries.reporting import (
    report_directory,
    verdict_is_allowed,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="SV.11.12 AI Provider Privacy Boundary Verification"
    )
    ...
    print(f"SV.11.12 AI Provider Privacy Boundary Verification: {report.verdict}")
