"""Deterministic report models for SV.11.4 execution verification."""
...
class ExecutionVerificationReport:
    """Full SV.11.4 execution verification report."""
    ...
    def write_markdown(self, path: Path) -> Path:
        path.parent.mkdir(parents=True, exist_ok=True)
        lines = [
            "# Standardized Execution, Errors, Timeouts, and Retries Verification "
            "(Epic 11, Slice 11.4)",
            "",
