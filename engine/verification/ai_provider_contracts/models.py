"""Deterministic report models for SV.11.2 Common AI Provider Contracts verification."""
...
class ContractVerificationReport:
    """Full SV.11.2 Common AI Provider Contracts verification report."""
    ...
    def write_markdown(self, path: Path) -> Path:
        path.parent.mkdir(parents=True, exist_ok=True)
        lines = [
            "# Common AI Provider Contracts Verification (Epic 11, Slice 11.2)",
            "",
