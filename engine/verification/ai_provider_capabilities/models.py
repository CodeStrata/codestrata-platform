"""Deterministic report models for SV.11.5 Provider Usage Metadata and Capability Discovery."""
...
class CapabilityVerificationReport:
    """Full SV.11.5 Provider Usage Metadata and Capability Discovery verification report."""
    ...
    def write_markdown(self, path: Path) -> Path:
        path.parent.mkdir(parents=True, exist_ok=True)
        lines = [
            "# Provider Usage Metadata and Capability Discovery Verification (Epic 11, Slice 11.5)",
            "",
