"""Deterministic report models for SV.11.7 AWS Bedrock Provider Migration."""
...
@dataclass(frozen=True, slots=True)
class BedrockMigrationVerificationReport:
    """Full SV.11.7 AWS Bedrock Provider Migration verification report."""
    ...
    def write_markdown(self, path: Path) -> Path:
        path.parent.mkdir(parents=True, exist_ok=True)
        lines = [
            "# AWS Bedrock Provider Migration Verification (Epic 11, Slice 11.7)",
            "",
