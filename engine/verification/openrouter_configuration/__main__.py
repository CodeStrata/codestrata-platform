"""CLI entry: ``python -m verification.openrouter_configuration``."""
...
from verification.openrouter_configuration.contract import REPORT_FILENAME, REPORT_MD_FILENAME
from verification.openrouter_configuration.reporting import report_directory, verdict_is_allowed
from verification.openrouter_configuration.runner import engine_root, run_verification


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="SV.11.10 OpenRouter Configuration Verification"
    )
    ...
    print(f"SV.11.10 OpenRouter Configuration Verification: {report.verdict}")
