...
Architecture precision corrections established exclusion of `.codestrata` workspace
...
```
src/codestrata/domain/technical_debt/
  ids.py
  taxonomy.py
  assessment/
    enums.py
...
src/codestrata/application/technical_debt/
  assessment/
    assembler.py
    factory.py
    artifacts.py
...
Default complexity ignore markers include `/.codestrata/` (and vendor/generated/
build outputs). Relative paths under `.codestrata/` are never measured.
...
```
src/codestrata/domain/evidence/language/complexity/
  enums.py
  identifiers.py
  models.py

src/codestrata/application/evidence/language/complexity/
  paths.py
  python_extractor.py
  java_extractor.py
  collector.py
...
src/codestrata/application/technical_debt/evidence/
...
- wiring complexity collection into `codestrata assess`
...
- wiring complexity collection into every `codestrata assess` run
...
```
src/codestrata/application/rules/technical_debt/
...
src/codestrata/application/technical_debt/assessment/
  assembler.py           # live/disabled/empty section assembly
  artifacts.py
  factory.py

src/codestrata/domain/technical_debt/ids.py   # RULE_* constants
```
