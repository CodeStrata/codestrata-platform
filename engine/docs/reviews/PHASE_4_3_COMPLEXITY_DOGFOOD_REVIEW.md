...
`src/codestrata/application/assessment`, `src/codestrata/application/incremental`,
`src/codestrata/application/architecture`, and `src/codestrata/interfaces/mcp`.
...
| - | -------- | -------- | ----- | ---- | ----------- | ---------------- |
| 1 | high | 4 | 4 | `src/codestrata/application/architecture/conclusions/service.py` | `codestrata.application.architecture.conclusions.service.ArchitectureConclusionService.build#8@71` | max_nesting_depth=5 (threshold 4); branch_point_count=34 (threshold 10); parameter_count=8 (threshold 5); physical_line_count=233 (threshold 50) |
| 2 | high | 4 | 4 | `src/codestrata/application/assessment/service.py` | `codestrata.application.assessment.service.AssessmentApplicationService._run_assessment_pipeline#31@457` | max_nesting_depth=6 (threshold 4); branch_point_count=84 (threshold 10); parameter_count=31 (threshold 5); physical_line_count=742 (threshold 50) |
| 3 | high | 4 | 4 | `src/codestrata/application/rules/architecture/view_builder.py` | `collect_raw_package_facts#6@159` | max_nesting_depth=5 (threshold 4); branch_point_count=25 (threshold 10); parameter_count=6 (threshold 5); physical_line_count=115 (threshold 50) |
| 4 | high | 4 | 4 | `src/codestrata/cli/enterprise.py` | `query_command#8@210` | max_nesting_depth=7 (threshold 4); branch_point_count=21 (threshold 10); parameter_count=8 (threshold 5); physical_line_count=84 (threshold 50) |
| 5 | high | 3 | 3 | `src/codestrata/application/architecture/assessment/assembler.py` | `codestrata.application.architecture.assessment.assembler.ArchitectureAssessmentAssembler.assemble#26@327` | branch_point_count=29 (threshold 10); parameter_count=26 (threshold 5); physical_line_count=223 (threshold 50) |
| 6 | high | 3 | 3 | `src/codestrata/application/architecture/conclusions/clustering.py` | `cluster_findings#2@119` | max_nesting_depth=8 (threshold 4); branch_point_count=30 (threshold 10); physical_line_count=126 (threshold 50) |
| 7 | high | 3 | 3 | `src/codestrata/application/assessment/service.py` | `_build_command_result#28@1701` | branch_point_count=27 (threshold 10); parameter_count=28 (threshold 5); physical_line_count=150 (threshold 50) |
| 8 | high | 3 | 3 | `src/codestrata/application/assessment/service.py` | `_run_ai_assessment#14@1376` | branch_point_count=11 (threshold 10); parameter_count=14 (threshold 5); physical_line_count=150 (threshold 50) |
| 9 | high | 3 | 3 | `src/codestrata/application/assessment/service.py` | `codestrata.application.assessment.service.AssessmentApplicationService.run#29@197` | branch_point_count=14 (threshold 10); parameter_count=29 (threshold 5); physical_line_count=174 (threshold 50) |
| 10 | high | 3 | 3 | `src/codestrata/application/enterprise/validation_service.py` | `codestrata.application.enterprise.validation_service.EnterpriseManifestValidationService.validate#3@73` | max_nesting_depth=6 (threshold 4); branch_point_count=45 (threshold 10); physical_line_count=290 (threshold 50) |
| 11 | high | 3 | 3 | `src/codestrata/application/incremental/impact.py` | `codestrata.application.incremental.impact.ImpactAnalyzer.analyze#6@31` | branch_point_count=28 (threshold 10); parameter_count=6 (threshold 5); physical_line_count=162 (threshold 50) |
| 12 | high | 3 | 3 | `src/codestrata/application/incremental/reuse.py` | `codestrata.application.incremental.reuse.ReusePolicy.evaluate#9@35` | branch_point_count=51 (threshold 10); parameter_count=9 (threshold 5); physical_line_count=180 (threshold 50) |
| 13 | high | 3 | 3 | `src/codestrata/application/rules/architecture/assessment.py` | `evaluate_architecture_pack_for_context_detailed#6@118` | branch_point_count=12 (threshold 10); parameter_count=6 (threshold 5); physical_line_count=121 (threshold 50) |
| 14 | high | 3 | 3 | `src/codestrata/application/rules/planner.py` | `codestrata.application.rules.planner.RulePlanner.plan#6@15` | branch_point_count=21 (threshold 10); parameter_count=6 (threshold 5); physical_line_count=120 (threshold 50) |
| 15 | high | 3 | 3 | `src/codestrata/application/technical_debt/assessment/assembler.py` | `codestrata.application.technical_debt.assessment.assembler.TechnicalDebtAssessmentAssembler.assemble#23@405` | branch_point_count=20 (threshold 10); parameter_count=23 (threshold 5); physical_line_count=167 (threshold 50) |
| 16 | high | 3 | 3 | `src/codestrata/interfaces/mcp/factory.py` | `create_mcp_server#12@22` | branch_point_count=15 (threshold 10); parameter_count=12 (threshold 5); physical_line_count=117 (threshold 50) |
| 17 | high | 3 | 3 | `src/codestrata/interfaces/mcp/tools/rules.py` | `register_rules_tools#2@14` | max_nesting_depth=5 (threshold 4); branch_point_count=11 (threshold 10); physical_line_count=118 (threshold 50) |
| 18 | high | 3 | 3 | `src/codestrata/reporting/ai_execution.py` | `build_ai_execution_document#15@65` | branch_point_count=44 (threshold 10); parameter_count=15 (threshold 5); physical_line_count=170 (threshold 50) |
| 19 | high | 3 | 3 | `src/codestrata/static_analysis/providers/pmd_discovery.py` | `resolve_pmd_executable#8@38` | branch_point_count=27 (threshold 10); parameter_count=8 (threshold 5); physical_line_count=90 (threshold 50) |
| 20 | high | 2 | 2 | `src/codestrata/ai/providers/bedrock.py` | `codestrata.ai.providers.bedrock.BedrockAIModelProvider.invoke#2@74` | branch_point_count=18 (threshold 10); physical_line_count=102 (threshold 50) |
