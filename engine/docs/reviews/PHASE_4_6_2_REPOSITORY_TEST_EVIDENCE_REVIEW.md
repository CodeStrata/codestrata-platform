...
Collectors do not import `codestrata.domain.testing` / `codestrata.application.testing`
...
- Candidates are under `tests/` plus example/fixture manifests; `.codestrata/` excluded.
