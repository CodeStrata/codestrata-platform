# Analysis Intelligence Conventions (Engine)

Descriptive conventions shared by Engine Analysis Intelligence verticals:
Architecture (4.2), Technical Debt (4.3), Dependency (4.4), Security (4.5), and
Test Intelligence (4.6). These conventions belong to the **Community Engine**
assessment pipeline. They are unrelated to the commercial CodeStrata Platform
package (`platform/`).
...
Test Intelligence includes domain foundation (4.6.1), Engine
...
Dependency Evidence for manifests, Repository-Sensitive Evidence for potentially
...
Security Evidence collector. Phase 4.5.2 adds Engine evidence provider
