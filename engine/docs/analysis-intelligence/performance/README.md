...
Package: `codestrata.domain.performance` / `codestrata.application.performance` /
`codestrata.application.rules.performance` / `codestrata.reporting.performance`.
Evidence: `codestrata.domain.evidence.repository_performance` /
`codestrata.application.evidence.repository_performance`.
