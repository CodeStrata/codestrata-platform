...
from codestrata.interfaces.mcp.envelope import McpDiagnostic, McpHealthResponse, McpToolStatus
from codestrata.interfaces.mcp.mapping import to_mcp_payload
from codestrata.interfaces.mcp.security import optional_filter, require_nonblank
from codestrata.interfaces.mcp.tools._common import (
    FINDINGS_DEFAULT,
    FINDINGS_MAX,
...
from codestrata_platform.rag.domain.retrieval import RetrievalRequest
...
def register_repository_health(
    ...
    def repository_health() -> dict[str, Any]:
        ...
        def _run() -> dict[str, Any]:
            ...
            if context.settings is not None:
                payload["execution_profile"] = context.settings.profile
                payload["enterprise_enabled"] = context.settings.enterprise.enabled
            return payload
