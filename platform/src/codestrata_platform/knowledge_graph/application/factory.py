...
from codestrata_platform.knowledge_graph.infrastructure.persistence import (
...
def policy_from_settings(settings: CodestrataSettings | None) -> EnterprisePolicy:
    if settings is None:
...
def create_enterprise_knowledge_service(
    *,
    ...
    if knowledge_directory is None:
        knowledge_directory = Path(".codestrata/knowledge")
