...
METRIC_HORIZONS: dict[str, str] = {
    ...
    "total_assessments": "bounded_period",
    ...
    "published_reports": "external",
    "github_stars": "external",
    "github_forks": "external",
    "community_sentiment": "external",
...
BOUNDED_LIMITATIONS: frozenset[str] = frozenset(
    {
        ...
        "github_public_api",
        "report_artifact_store_registry",
        "community_sentiment_not_yet_collected",
        "voluntary_feedback_only",
        "no_responses_yet",
        "explicit_yes_no_only",
    }
)
