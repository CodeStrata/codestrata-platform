    ...
    def get_by_portfolio_snapshot(
        ...
        if snapshot.organization_id != query.organization_id:
            raise ValidationError(
                "Strategic roadmap tenant mismatch",
                reason_code="strategic_roadmap_tenant_mismatch",
            )
        ...
        if (
            ...
            raise ValidationError(
                "Strategic roadmap portfolio mismatch",
                reason_code="strategic_roadmap_portfolio_mismatch",
            )
        details = self._executive_intelligence.get(
            GetExecutiveIntelligenceQuery(
