"""Executive Presentation application queries."""
...
class GetExecutivePresentationQuery:
...
@dataclass(frozen=True, slots=True)
class GetLatestExecutivePresentationQuery:
...
@dataclass(frozen=True, slots=True)
class GetExecutivePresentationByPortfolioSnapshotQuery:
