"""Portfolio Retrieval Index persistence schema.

Revision ID: 0009_portfolio_retrieval
...
index are created for ANN retrieval, mirroring the ``0006_engineering_retrieval``
pattern.
"""
...
revision: str = "0009_portfolio_retrieval"
down_revision: str | None = "0008_portfolio_intelligence"
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_engineering_portfolio_retrieval_indexes_portfolio_id",
        "engineering_portfolio_retrieval_indexes",
        ["portfolio_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_engineering_portfolio_retrieval_indexes_status",
        "engineering_portfolio_retrieval_indexes",
        ["status"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "index_id",
            sa.String(length=160),
            sa.ForeignKey("engineering_portfolio_retrieval_indexes.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "portfolio_id",
    ...
    op.create_index(
        "ix_engineering_portfolio_retrieval_documents_index_id",
        "engineering_portfolio_retrieval_documents",
        ["index_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_engineering_portfolio_retrieval_documents_checksum",
        "engineering_portfolio_retrieval_documents",
        ["checksum"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "document_id",
            sa.String(length=160),
            sa.ForeignKey("engineering_portfolio_retrieval_documents.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "index_id",
    ...
    op.execute(
        "ALTER TABLE engineering_portfolio_retrieval_chunks "
        "ADD COLUMN search_vector tsvector "
        "GENERATED ALWAYS AS (to_tsvector('english', coalesce(search_vector_text, ''))) STORED"
    )
    op.create_index(
        "ix_engineering_portfolio_retrieval_chunks_index_id",
        "engineering_portfolio_retrieval_chunks",
        ["index_id"],
    )
    op.create_index(
        "ix_engineering_portfolio_retrieval_chunks_document_id",
        "engineering_portfolio_retrieval_chunks",
        ["document_id"],
    )
    op.create_index(
        "ix_engineering_portfolio_retrieval_chunks_checksum",
        "engineering_portfolio_retrieval_chunks",
        ["checksum"],
    )
    op.execute(
        "CREATE INDEX ix_engineering_portfolio_retrieval_chunks_search_vector "
        "ON engineering_portfolio_retrieval_chunks USING GIN (search_vector)"
    )

    if has_pgvector:
        op.execute(
            f"ALTER TABLE engineering_portfolio_retrieval_chunks "
        ...
        op.execute(
            ...
            DO $$
            BEGIN
                CREATE INDEX ix_engineering_portfolio_retrieval_chunks_embedding_hnsw
                ON engineering_portfolio_retrieval_chunks
    ...
    op.create_index(
        "ix_engineering_portfolio_retrieval_index_runs_index_id",
        "engineering_portfolio_retrieval_index_runs",
        ["index_id"],
    )
    op.create_index(
...
def downgrade() -> None:
    op.drop_table("engineering_portfolio_retrieval_index_runs")
    op.drop_table("engineering_portfolio_retrieval_chunks")
    op.drop_table("engineering_portfolio_retrieval_documents")
    op.drop_table("engineering_portfolio_retrieval_indexes")
