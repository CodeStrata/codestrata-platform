...
```bash
codestrata enterprise init enterprise
codestrata enterprise validate enterprise
codestrata enterprise build enterprise
codestrata enterprise query applications --domain student-services
codestrata enterprise inspect application:student-information-system
```
...
- `codestrata.domain.enterprise` — entities, relationships, identities
- `codestrata.application.enterprise` — validate, build, link, query, persist ports
- `codestrata.infrastructure.enterprise` — YAML loader, file graph store, workspace init
- CLI: `codestrata enterprise …`
