...
**Owner:** `platform/` (private). Not shipped as Community Engine documentation.
...
| ------- | ------- | ----------- |
| Phase 2 engineering knowledge store | `application.knowledge` + SQLite | `.codestrata/knowledge/` |
...
[retrieval.md](retrieval.md). Assessment MCP overview (Engine):
[engine/docs/mcp/overview.md](../../../engine/docs/mcp/overview.md).
