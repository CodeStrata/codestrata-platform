"""Slice 8.15 packaging / architecture boundary tests."""
...
VERIFICATION = PLATFORM / "verification" / "community_data_lake_completion"
...
def test_engine_does_not_import_completion_verification() -> None:
    hits = []
    for path in ENGINE.rglob("*.py"):
        text = path.read_text(encoding="utf-8")
        if "verification.community_data_lake_completion" in text:
