"""Domain completion checks for Slice 13.15 (initialization_completion)."""
...
def check(monorepo: Path) -> list[CheckResult]:
    ...
    hint = "initialization_completion".replace("_completion", "").replace("_absence", "").replace("_boundary", "")
    mapping = {
        "workflow": "workflow",
        "cli": "cli",
