"""Invoke prior Slice 13.1–13.14 authoritative runners."""
...
from verification.vscode_epic13_completion.contract import PRIOR_SLICE_RUNNERS
...
def run_prior_slice_verifiers(
    ...
    """Return normalized prior results: slice -> {verdict, total_checks, failed_checks}."""
    results: dict[str, dict[str, Any]] = {}
    checks: list[CheckResult] = []
    defects: list[Defect] = []

    for slice_id, module_name, schema, title in PRIOR_SLICE_RUNNERS:
        try:
