"""Determinism helpers for Slice 17.2."""
...
def report_text_is_safe(text: str) -> tuple[bool, str]:
    ...
    if "codestrata_infra" in text and "expected_operator_profile" not in text:
        # profile name as boolean field values is ok; bare profile string as data is not ideal
        pass
    return True, "safe"
