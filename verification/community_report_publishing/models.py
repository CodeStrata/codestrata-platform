...
class Report:
    ...
    publishing_register: dict[str, Any] = field(default_factory=dict)
    storage_register: dict[str, Any] = field(default_factory=dict)
    epic17_boundary: dict[str, Any] = field(default_factory=dict)
    platform_reports: dict[str, Any] = field(default_factory=dict)
