...
class Report:
    ...
    status_module: dict[str, Any] = field(default_factory=dict)
    status_live: dict[str, Any] = field(default_factory=dict)
    github_cache: dict[str, Any] = field(default_factory=dict)
    website: dict[str, Any] = field(default_factory=dict)
    manifest: dict[str, Any] = field(default_factory=dict)
    insights: dict[str, Any] = field(default_factory=dict)
    docs: dict[str, Any] = field(default_factory=dict)
    reports_domain: dict[str, Any] = field(default_factory=dict)
