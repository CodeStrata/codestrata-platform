"""Models for Slice 15.10 dashboard verification."""
...
@dataclass
class CommunityInsightsDashboardReport:
    schema_name: str
    schema_version: str
    verification_id: str
    verdict: Verdict
    epic: str = "15"
    slice: str = "15.10"
    policy_id: str = "codestrata-insights-dashboard-policy"
    ...
    slice_15_12_boundary_status: str = "not_executed"
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "slice": self.slice,
            "slice_15_12_boundary_status": self.slice_15_12_boundary_status,
