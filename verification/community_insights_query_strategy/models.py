"""Models for Slice 15.5 query strategy verification."""
...
@dataclass
class CommunityInsightsQueryStrategyReport:
    schema_name: str
    schema_version: str
    verification_id: str
    verdict: Verdict
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "athena_status": self.athena_status,
            ...
            "direct_s3_preferred": self.direct_s3_preferred,
            "epic": self.epic,
            "failed_checks": self.failed_checks,
            "lifetime_strategy": self.lifetime_strategy,
