...
Finalize public Marketplace narrative for extension **0.2.2** so visitors can
...
- Version: **0.2.2** (Community Engine/CLI remains **0.2.1**)
...
| Compatibility | Extension 0.2.2 → CLI `0.2.x` |
