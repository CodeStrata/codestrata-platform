# VS Code plugin (placeholder)

> **Status:** Placeholder only — not implemented in Phase 5.23.

This directory is reserved for the future **codestrata-vscode** public mirror.
