...
from aimf.config.settings import RepositoryAiReadinessEvidenceSettings
...
_APP_PACKAGE = Path("src/aimf/application/evidence/repository_ai_readiness")
_FORBIDDEN_IMPORT_PREFIXES = (
    "aimf.domain.ai_readiness",
    "aimf.application.ai_readiness",
