...
from aimf.application.rules.dependency.rules import (
...
from aimf.domain.rules.enums import RuleCategory, RuleConfidence, RuleResultStatus, RuleSeverity
...
def _context(evidence: AggregatedDependencyEvidence | None) -> RuleExecutionContext:
    return RuleExecutionContext(
        repository=RepositoryFactView(
            repository_id="repo:test",
            relative_paths=("pom.xml", "pyproject.toml"),
        ),
