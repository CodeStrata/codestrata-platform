...
from aimf.application.onboarding.manifest import (
...
def _settings(tmp_path: Path, repo: Path) -> AimfSettings:
...
def test_cli_onboard_injected_settings(
    ...
    monkeypatch.setattr("aimf.cli.onboard.run_onboarding", fake_run)
