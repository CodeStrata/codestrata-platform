...
from aimf.application.ai_readiness.assessment.inventory import execution_facts_from_status_map
from aimf.application.ai_readiness.synthesis import synthesize_ai_readiness
...
from aimf.domain.ai_readiness.assessment.identifiers import SECTION_SCHEMA_VERSION
...
def test_synthesis_failure_isolation() -> None:
    with patch(
        "aimf.application.ai_readiness.assessment.assembler.synthesize_ai_readiness",
