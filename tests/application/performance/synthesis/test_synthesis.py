...
from aimf.application.performance.assessment.inventory import execution_facts_from_status_map
from aimf.application.performance.synthesis import synthesize_performance
...
from aimf.domain.performance.assessment.identifiers import SECTION_SCHEMA_VERSION
...
def test_synthesis_failure_isolation() -> None:
    with patch(
        "aimf.application.performance.assessment.assembler.synthesize_performance",
