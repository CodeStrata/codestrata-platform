    ...
    "codestrata": [
        ...
        (
            ...
            "A high severity security finding notes secret redaction gaps in diagnostic output.",
            {
                ...
                "file_path": "src/aimf/security/database_url.py",
            },
        ),
        (
            "dep",
        ...
        (
            ...
            {"source_type": "repository_file", "file_path": "src/aimf/repository_auth/"},
        ),
        (
            "test",
        ...
        (
            ...
            {"source_type": "cloud", "file_path": "aimf.toml"},
        ),
        (
            "debt",
            "Technical-debt recommendations suggest consolidating report rendering helpers.",
            {"source_type": "recommendation", "file_path": "src/aimf/reporters/"},
        ),
    ],
    "spring-petclinic": [
        (
