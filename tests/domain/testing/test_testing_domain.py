...
from aimf.domain.testing.taxonomy import (
    TEST_CATEGORIES,
    TestCategory,
...
def test_pack_and_section_constants_stable() -> None:
    ...
    assert SECTION_SCHEMA_VERSION == "1.0.0"
