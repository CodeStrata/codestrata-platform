...
from aimf.ai.providers.common import ProviderThrottlingError, retry_call
from aimf.ai.providers.registry import (
...
from aimf.infrastructure.embedding.bedrock import BedrockEmbeddingProvider
from aimf.infrastructure.embedding.factory import (
    EmbeddingProviderConfigurationError,
    create_embedding_provider,
)
from aimf.infrastructure.embedding.openai_provider import OpenAIEmbeddingProvider
...
def test_ai_settings_reject_unknown_and_unused_provider_ok(tmp_path: Any) -> None:
    ...
    create_answer_provider(aimf_settings=settings)
