...
``[ai].answer_provider`` when ``AimfSettings`` is supplied; otherwise use
...
from aimf.config.settings import AimfSettings, KnowledgeAnsweringSettings
...
def create_answer_provider(
    ...
    **kwargs: Any,
    ...
    answering = settings or (
        aimf_settings.knowledge.answering
