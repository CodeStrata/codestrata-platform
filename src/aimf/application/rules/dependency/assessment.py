...
from aimf.application.evidence.dependency.io import load_dependency_manifest_texts
from aimf.application.evidence.dependency.service import (
    create_dependency_evidence_service,
)
from aimf.application.rules.dependency.pack import DependencyRulePack
...
def dependency_evidence_collection_enabled(settings: AimfSettings | None) -> bool:
    if settings is None:
        return False
