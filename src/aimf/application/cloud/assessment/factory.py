...
from aimf.config.settings import AimfSettings, CloudAnalysisSettings
...
def cloud_pack_enabled(settings: AimfSettings | None) -> bool:
...
def cloud_analysis_enabled(settings: AimfSettings | None) -> bool:
...
def cloud_report_section_enabled(settings: AimfSettings | None) -> bool:
