...
from aimf.config.settings import AimfSettings, AiReadinessAnalysisSettings
...
def ai_readiness_pack_enabled(settings: AimfSettings | None) -> bool:
...
def ai_readiness_analysis_enabled(settings: AimfSettings | None) -> bool:
...
def ai_readiness_report_section_enabled(settings: AimfSettings | None) -> bool:
