...
from aimf.application.acceptance.targets import PREDEFINED_QUESTIONS
...
from aimf.domain.knowledge import GroundedAnswerRequest, KnowledgeCorpus, RetrievalScope
